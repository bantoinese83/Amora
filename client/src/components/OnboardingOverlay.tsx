...
const STEPS: Step[] = [
  {
    ...
    content: "Your AI companion for daily reflection and clarity. Let's take a quick tour.",
  },
  {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex flex-col">
      ...
      <div className="relative w-full h-full pointer-events-none">
        ...
        {!isCentered && position && (
          <div
            className="absolute w-12 h-12 border-2 border-amora-400 rounded-full animate-ping opacity-75"
            style={{
        ...
        <div
          className={`
                ...
                bg-slate-900 border border-slate-700 p-6 rounded-2xl shadow-2xl max-w-sm w-[90%]
        ...
        >
          <div className="flex justify-between items-start mb-4">
            <span className="text-xs font-bold text-amora-400 uppercase tracking-wider">
          ...
          {!isCentered && (
            <div
              className={`absolute left-1/2 -translate-x-1/2 w-4 h-4 bg-slate-900 border-l border-t border-slate-700 transform rotate-45 ${
